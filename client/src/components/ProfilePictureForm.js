...
class ProfilePictureForm extends PureComponent {
  ...
  handleUpload = (event) => {
    ...
    if (imgSrc) {
      ...
      dispatch(postActions.addProfilePicture(fd));
    ...
    return (
      <div>
        {imgSrc !== null ? (
          <div>
            <div style={{ marginBottom: "1%" }}>
              <label className="ui icon button fluid">
                <div className="flex gap-x-2 items-center justify-center text-[10px]">
          ...
          <div>
            <label className="ui icon button fluid upload-profile-image  !py-8 !m-0 !text-[14px] !font-medium !text-blue-500">
              Upload Photo
              <input
                style={{ display: "none" }}
                ref={this.fileInputRef}
